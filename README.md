...
- `cloud-stack-estimator/live-pricing.example.json` – sample schema for live pricing source
...
- You can enable live pricing JSON in the UI and point to a compatible endpoint.
